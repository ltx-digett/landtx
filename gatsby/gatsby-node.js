...
exports.createPages = async ({ actions, graphql, reporter }, options) => {
  ...
  result.data.property.nodes.forEach(node => {
    ...
    actions.createPage({
      path: "property/" + node.slug.current + "/static-maps",
      component: require.resolve("./src/templates/property-static.js"),
      context: { id },
    })
    actions.createPage({
      path: "property/" + node.slug.current + "/interactive-map",
      component: require.resolve("./src/templates/property-interactive.js"),
      context: { id },
    })
  })
}
